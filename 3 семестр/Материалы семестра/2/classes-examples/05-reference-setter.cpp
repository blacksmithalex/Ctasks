...
class Vector2d {
 private:
  ...
  double y;
 public:
 /* Функция для чтения. Она может возвращать либо значение либо константную ссылку.
    Например, следующий код предпочтителен в случаях, когда возвращаемое значение
    долго копируется.
