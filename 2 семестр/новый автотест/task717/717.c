...
int main(void)
{
    ...
    // Отметить столбцы, содержащие элементы в отрезке [M, N]
    ...
    // Модификация элементов по условиям задачи (пузырьковая сортировка)
    for (int i = 0; i < L; i++) // проходимся по каждой строке
    {
